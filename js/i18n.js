...
export const translations = {
  fr: {
    ...
    'mp.your_turn_title': '🟢 C\'EST À VOTRE TOUR !',
    'mp.your_turn_sub': '👉 Choisissez une case vide pour poser un pays !',
    'mp.opponent_turn_banner': '⏳ TOUR DE L\'ADVERSAIRE',
    'mp.opponent_turn_title': '⏳ TOUR DE L\'ADVERSAIRE',
    'mp.opponent_turn_sub': 'En attente du coup adverse...',
    'mp.urgent_timer_sub': '⚡ Dépêchez-vous, le temps presse !',
    'mp.hc_intro_eyebrow': '🔥 DÉFI 1V1 HARDCORE ACTIVÉ !',
    'mp.hc_intro_title': 'Condition Mondiale Imposée',
    'mp.hc_intro_fatal_warning': '⚠️ Tenter un pays interdit fait immédiatement passer la main à l\'adversaire !',
    'mp.hc_intro_btn': '⚔️ J\'accepte le défi !',
    'mp.hc_reminder_title': 'DÉFI ACTIF :',
    'mp.hc_reminder_tag': '🔥 DÉFI MONDIAL ACTIF :',
    ...
    'br.mode_bomb_title': '💣 Bombe Party (Tours rapides)',
    'br.mode_bomb_desc': 'Chacun votre tour, citez un pays respectant la condition. Erreur ou chrono = vie perdue !',
    'br.bomb_difficulty_label': 'DIFFICULTÉ DE LA BOMBE :',
    'br.bomb_diff_1': '1 condition (Classique 💣)',
    'br.bomb_diff_2': '2 conditions croisées (Duo Expert ⚔️)',
    'br.bomb_diff_escalation': 'Progression dynamique (Tension selon les vies 📈)',
    'br.lives_label': 'NOMBRE DE VIES :',
    'br.lives_1': '1 vie (Mort Subite 💀)',
    'br.lives_2': '2 vies (Rapide & Nerveux ⚡)',
    'br.lives_3': '3 vies (Classique ❤️)',
    ...
    'br.escalation_feed': '⚡ TENSION MAXIMALE ! Les vies diminuent : la bombe exige désormais {count} CONDITIONS !',
    ...
    'br.restart_game_host': '🚀 Relancer la partie',
    'br.request_rematch_guest': '🔄 Demander une revanche',
    'br.guest_waiting_replay': '⏳ En attente que l\'hôte relance...',
    'br.return_lobby_btn': '🏠 Revenir au salon d\'attente',
    'br.back_to_menu': 'Quitter l\'arène',
    'br.fuse_accelerated': '🔥 VITESSE MAX !',
    'br.you_badge': '(VOUS)',
  ...
  en: {
    ...
    'mp.your_turn_title': '🟢 IT\'S YOUR TURN!',
    'mp.your_turn_sub': '👉 Choose an empty cell to play a country!',
    'mp.opponent_turn_banner': '⏳ OPPONENT\'S TURN',
    'mp.opponent_turn_title': '⏳ OPPONENT\'S TURN',
    'mp.opponent_turn_sub': 'Waiting for opponent move...',
    'mp.urgent_timer_sub': '⚡ Hurry up, time is running out!',
    'mp.hc_intro_eyebrow': '🔥 1V1 HARDCORE CHALLENGE ACTIVATED!',
    'mp.hc_intro_title': 'Global Challenge Enforced',
    'mp.hc_intro_fatal_warning': '⚠️ Picking an illegal or invalid country immediately gives the turn to your opponent!',
    'mp.hc_intro_btn': '⚔️ Challenge accepted!',
    'mp.hc_reminder_title': 'ACTIVE CHALLENGE:',
    'mp.hc_reminder_tag': '🔥 GLOBAL CHALLENGE ACTIVE:',
    ...
    'br.mode_bomb_title': '💣 Bomb Party (Fast rounds)',
    'br.mode_bomb_desc': 'Take turns naming a country matching the condition. Error or timeout = lost life!',
    'br.bomb_difficulty_label': 'BOMB DIFFICULTY:',
    'br.bomb_diff_1': '1 condition (Classic 💣)',
    'br.bomb_diff_2': '2 crossed conditions (Expert Duo ⚔️)',
    'br.bomb_diff_escalation': 'Dynamic progression (Escalates with lost lives 📈)',
    'br.lives_label': 'NUMBER OF LIVES:',
    'br.lives_1': '1 life (Sudden Death 💀)',
    'br.lives_2': '2 lives (Fast & Intense ⚡)',
    'br.lives_3': '3 lives (Classic ❤️)',
    ...
    'br.escalation_feed': '⚡ MAXIMUM TENSION! Lives are dropping: the bomb now requires {count} CONDITIONS!',
    ...
    'br.restart_game_host': '🚀 Restart game',
    'br.request_rematch_guest': '🔄 Request rematch',
    'br.guest_waiting_replay': '⏳ Waiting for host to restart...',
    'br.return_lobby_btn': '🏠 Return to lobby',
    'br.back_to_menu': 'Leave arena',
    'br.fuse_accelerated': '🔥 MAX SPEED!',
    'br.you_badge': '(YOU)',
